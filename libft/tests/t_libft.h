...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/04 18:15:29 by mroux             #+#    #+#             */
/*   Updated: 2019/11/04 18:17:23 by mroux            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			t_ft_strchr(char *(*t_f)(const char *, int),
				char *(*f)(const char *, int));
int			t_ft_strcmp();
int			t_ft_strncmp();
int			t_ft_str_cpycat(size_t (*t_f)(char *, const char *, size_t),
